...
st.write(f"Jika tenaga kerja bertambah(L) {L_val} unit, dengan bahan baku {K_val} unit (∂C/∂L) (L={L_val}, K={K_val}) = {dC_dL_val}", "Unit")
st.write(f"Jika bahan baku bertambah(K) {K_val} unit, dengan tenaga kerja {L_val} unit (∂C/∂K) (L={L_val}, K={K_val}) = {dC_dK_val}", "Unit")
